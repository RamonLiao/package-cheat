...
#
# Usage:
#   ./list-node-modules.sh [path] [--sort=size|path|date]
################################################################################
...
# Only node_modules for this script
ENABLED_ARTIFACT_NAMES=("node_modules")
ENABLED_ARTIFACT_DESCS=("JavaScript dependencies")

# No disabled artifacts for this specialized script
...
search_all_artifacts() {
    ...
    echo -e "${BOLD}${CYAN}  Node Modules in $search_path${RESET}"
    echo -e "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RESET}"
    echo ""
