...
################################################################################
# List Python Virtual Environments - Find all Python venvs
#
# Description:
#   Finds and lists all Python virtual environments with size information
#
# Usage:
#   ./list-python-venvs.sh [path] [--sort=size|path|date]
################################################################################
...
# Enabled by default
ENABLED_ARTIFACT_NAMES=(".venv" "venv" "env")
ENABLED_ARTIFACT_DESCS=("Python virtual environment" "Python virtual environment" "Python virtual environment")

# Available but disabled by default
DISABLED_ARTIFACT_NAMES=()
DISABLED_ARTIFACT_DESCS=()

# Combined arrays for lookup
ALL_ARTIFACT_NAMES=("${ENABLED_ARTIFACT_NAMES[@]}")
...
search_all_artifacts() {
    ...
    echo -e "${BOLD}${CYAN}  Python Virtual Environments in $search_path${RESET}"
    echo -e "${BOLD}${CYAN}═══════════════════════════════════════════════════════════════${RESET}"
    echo ""
